...
class _FaceAuthLoginScreenState extends State<FaceAuthLoginScreen>
  ...
  Future<void> _captureAndMarkAttendance() async {
    ...
    if (_activeSession != null) {
      _setStatus('Attendance already active for today', StatusChipType.alert);
      return;
    }
    ...
    try {
      ...
      if (mounted) context.go('/attendance-details');
    } catch (error) {
      if (error is StateError) {
        _setStatus(error.message, StatusChipType.alert);
      } else {
